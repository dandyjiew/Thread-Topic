...
public class Method31 {
    ...
    public static void main(String[] args) {
        ...
        //异步的概念：
        Future<Integer> futureTask1 = executor.submit(callableTask1);
        Future<Integer> futureTask2 = executor.submit(callableTask2);
        ...
        try {
            ...
            if (futureTask1.isDone()) {
                ...
                System.out.println("task1获取得到结果 " + futureTask1.get() + " 共耗时: " + (System.currentTimeMillis() - time));
            }
            ...
            if (futureTask2.isDone()) {
                ...
                System.out.println("task2获取得到结果 " + futureTask2.get() + " 共耗时: " + (System.currentTimeMillis() - time));
            }
